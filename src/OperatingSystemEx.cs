...
internal static class OperatingSystemEx
{
	...
	public static bool IsWindows10() => OperatingSystem.IsWindowsVersionAtLeast(10);
...
#else
	public static bool IsWindows10() => RuntimeInformation.IsOSPlatform(OSPlatform.Windows) &&
